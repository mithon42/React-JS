...
function Html() {
  return (
    <div className="bg-[#D9EEE1] py-14 px-10 flex justify-center gap-5">
      <div className="w-[430px] text-center flex flex-col justify-center">
        <h2 className="text-[80px] font-bold">HTML</h2>
        <p className="font-bold text-lg">The language for building web pages</p>
        ...
        <div className="flex flex-col mx-auto mt-6 gap-6">
          ...
          <button className="text-black w-[200px] h-[45px] rounded-full font-medium bg-[#FFF080]">
            Video Tutorial
          </button>
      ...
      <div className="bg-[#E7E9EB] pt-5 pb-2 px-3 w-[430px] rounded-md shadow-2xl flex flex-col gap-3">
        <h4 className="text-xl font-bold">HTML Example:</h4>
        <img src={htmlBg} alt="html-img" />
        <button className="text-white w-[200px] h-[45px] rounded-full font-medium bg-brandColor">
          Try it Yourself
        </button>
      </div>
